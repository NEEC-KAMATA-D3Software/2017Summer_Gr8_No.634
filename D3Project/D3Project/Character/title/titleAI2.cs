    ...
    class titleAI2 : AI
    {
        ...
        public titleAI2()
        {
            positions = new List<Vector2>()
            {
                ...
                new Vector2(70.0f, 50.0f), new Vector2(70.0f, 824.0f), new Vector2(730.0f, 824.0f), new Vector2(730.0f, 50.0f),
                new Vector2(730.0f, 824.0f), new Vector2(70.0f, 1000.0f),new Vector2(730.0f, 824.0f), new Vector2(70.0f, 980.0f)
            };
            current = 0;
        }
