...
{
    class THREEWAY : Character
    {
        private Vector2 playerPosition;  //プレイヤーの位置
        private Vector2 velocity;        //移動量
        private Timer timer;

        public THREEWAY(Vector2 position, float deleteTime, ICharacterMediator mediator) : base("THREEWAY_Item32", "THREEWAY_Item", position, 16.0f, mediator)
        {
